...
class Cube:
    ...
    def set_mov(self, movement: str) -> None:
        ...
        if movement == "U":
            ...
            self.faces[self.UP][0] = save[self.BACK][6]
            self.faces[self.UP][3] = save[self.BACK][3]
            self.faces[self.UP][6] = save[self.BACK][0]
            ...
            self.faces[self.BACK][0] = save[self.DOWN][0]
            self.faces[self.BACK][3] = save[self.DOWN][3]
            self.faces[self.BACK][6] = save[self.DOWN][6]
        elif movement == "L'":
            ...
            self.faces[self.DOWN][0] = save[self.BACK][6]
            self.faces[self.DOWN][3] = save[self.BACK][3]
            self.faces[self.DOWN][6] = save[self.BACK][0]
            self.faces[self.BACK][0] = save[self.UP][0]
            self.faces[self.BACK][3] = save[self.UP][3]
            self.faces[self.BACK][6] = save[self.UP][6]
        elif movement == "R":
            ...
            self.faces[self.DOWN][2] = save[self.BACK][8]
            self.faces[self.DOWN][5] = save[self.BACK][5]
            self.faces[self.DOWN][8] = save[self.BACK][2]
            self.faces[self.BACK][2] = save[self.UP][2]
            self.faces[self.BACK][5] = save[self.UP][5]
            self.faces[self.BACK][8] = save[self.UP][8]
        elif movement == "R'":
            ...
            self.faces[self.UP][2] = save[self.BACK][2]
            self.faces[self.UP][5] = save[self.BACK][5]
            self.faces[self.UP][8] = save[self.BACK][8]
            ...
            self.faces[self.BACK][2] = save[self.DOWN][2]
            self.faces[self.BACK][5] = save[self.DOWN][5]
            self.faces[self.BACK][8] = save[self.DOWN][8]
        elif movement == "F":
